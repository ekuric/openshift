...
def main():
    try:
        options, args = getopt.getopt(sys.argv[1:], "r:i:o:t:p:x:y:h",
    ...
    dataArray = np.genfromtxt(interimfile, delimiter=',',usecols=(1,3,5),dtype=None, autostrip=1, case_sensitive=True, names=True,
                              deletechars="""~!@#$%^&*()=+~\|]}[{';: /?>,<""")
    # dtype=None
    # names=True
    # usecol = (1,10)
