https://github.com/ekuric/openshift/blob/master/ebsscale/addebs.py\[addebs.py] is script to allocated desired number of EBS volumes and attach them to instance from where
script is run.
